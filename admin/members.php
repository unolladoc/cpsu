...
<div id="sentDocumentsModal" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="false">
    <div class="modal-dialog modal-lg">
        <form></form>
        <div id="printmodaldetails" class="modal-content" style="padding:20px;">
            <div style="padding:0px;" class="modal-header">
                ...
                <span>
                    <h5 class="modal-title"><span id="exampleModalLabel">Sent Documents</span>

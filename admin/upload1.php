        ...
        if ($uploadOk == 1) 
            {
                ...
                //     {
                        ...
                        $filedest = json_encode($customcampus);
                        $sql = "INSERT INTO files values('$newid','$target_path_new','$newbasename_filename_name','$filedescription','$fileextension','$filepurpose','$filerevision','$fileuploader','$fileorigin','$filedest',CAST('$datenow' as datetime),0,0,'');" ;

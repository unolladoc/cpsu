...
-- Dumping data for table cpsu.logs: ~38 rows (approximately)
DELETE FROM `logs`;
...
INSERT INTO `user` (`id`, `username`, `password`, `name`, `campus`, `office`, `type`) VALUES
	...
	(0000000003, 'unolladoc@gmail.com', '21232f297a57a5a743894a0e4a801fc3', 'ben', 1, 1002, 2),
	(0000000004, 'rubenlladoc@gmail.com', '21232f297a57a5a743894a0e4a801fc3', ' Ruben Lladoc', 1, 1007, 2);

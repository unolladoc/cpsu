...
<?php
  ...
  $totalformat = number_format($reg,2,".",",");
        ...
        <div class="col-md-12">
            <div class="card card-plain">
              <div class="card-header">
                <h4 class="card-title"> Summary of Batch </h4>
                <h5>Total Registration: <strong>&#8369; <?php echo $totalformat?></strong></h5>
                ...
                <div class="table-responsive">
                  <table class="table">
                      ...
                      if ($result->num_rows > 0) {
                          ...
                          $sql2 = "SELECT SUM(amount) as totalbatchmoney FROM registration WHERE valid=1 && batch_no=".$row['batch_no'].";";
                          ...
                          $moneyformat = number_format($row2['totalbatchmoney'],2,".",",");
                          echo '<td>
                                    &#8369;'.$moneyformat.'
                                  </td>  
                                </tr>';

...
?>
	...
	<title>Gross Income Summary</title>
        ...
        <div class="col-md-12">
            <div class="card card-plain">
              <div class="card-header">
                <h4 class="card-title"> Summary of Gross Income</h4>
                <p class="category"> Gross Income = Total Registration + Total Donation + Other Income(Total)</p>  
              </div>
              <div class="card-body">
                  ...
                  <table class="table">
                      <thead class=" text-primary">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td  class="text-right">
                            <strong>Gross Income (Total)</strong> 
                            </td>
                            <td class="text-right">

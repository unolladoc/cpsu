      ...
      <nav class="navbar navbar-expand-lg fixed-top navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <button class="btn btn-info btn-round btn-lg" data-toggle="modal" data-target="#registerModal" data-dismiss="modal">Add Other Income</button>
            <span style="margin: 20px;"></span>

            <?php
              $sql1 = "SELECT count(amount) as regbatch FROM otherincome WHERE valid=1;";
            ...
            ?>
            <a class="navbar-brand" href="#">Number of Other Income: <strong><?php echo $row1['regbatch']; ?></strong></a>
            <span style="margin: 20px;"></span>
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table" id="myTable">
                    ...
                    <tbody>
                      <?php 
                          $sql = "SELECT * FROM otherincome ORDER BY datetime DESC";
          ...
          <div class="modal-body">
            <form method="post" action="verify.php">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-12">
                  <input type="hidden" class="form-control" id="" name="from" value="otherincome.php">
                </div>
              </div>
...
<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="registerModal" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-lg" >
    <form method="post" action="otherin.php" id="registerBatchForm" name="registration_form">
    <div class="modal-content">
      <div class="modal-header">

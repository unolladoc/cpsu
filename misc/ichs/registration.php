      ...
      <nav class="navbar navbar-expand-lg fixed-top navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <button class="btn btn-info btn-round btn-lg" data-toggle="modal" data-target="#registerModal" data-dismiss="modal">Register Batch</button>
            <span style="margin: 20px;"></span>

            <?php
              $sql1 = "SELECT count(DISTINCT batch_no) as regbatch FROM registration WHERE valid=1;";
              $result1 = $conn->query($sql1);

              $sql2 = "SELECT SUM(amount) as totalreg FROM registration WHERE valid=1;";
            ...
            ?>
            <a class="navbar-brand" href="#">Number of Registered Batch: <strong><?php echo $row1['regbatch']; ?></strong></a>
            <span style="margin: 20px;"></span>
          ...
          <div class="modal-body">
            <form method="post" action="verify.php">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-12">
                  <input type="hidden" class="form-control" id="" name="from" value="registration.php">
                </div>
              </div>
...
<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="registerModal" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog modal-lg" >
    <form method="post" action="register.php" id="registerBatchForm" name="registration_form">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
        ...
        <div class="input-group">
          <input type="text" class="form-control form-control-lg" required="required" list="datalistyear" id="yearbatch" name="batchyear">
        </div>
...
if(isset($_GET['sucess'])){
    ...
    echo "<script>
            ...
            message: 'Batch: <strong>".$_GET['b']."</strong> Amount: <strong>&#8369;".$moneyformat2."</strong>' 
            },{
...
function getRowID(r) {
  ...
  var bch = document.getElementById("myTable").rows[r].cells.item(1).innerHTML;

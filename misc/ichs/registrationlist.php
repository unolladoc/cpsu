        ...
        <div class="col-md-12">
            <div class="card card-plain">
              <div class="card-header">
                <h4 class="card-title"> Registraion List </h4>
                <h5>Total Registraion: <strong>&#8369; <?php echo $totalregformat?></strong></h5>
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table">
                      <?php
                      $sql = "SELECT * FROM registration where valid=1 ORDER BY batch_no";

...
<?php
  ...
  $sql2 = "SELECT SUM(amount) as totalreg FROM registration WHERE valid=1 && batch_no='$year';";
        ...
        <div class="col-md-12">
            <div class="card card-plain">
              <div class="card-header">
                <h4 class="card-title"> Summary of Batch <?php echo $year ?></h4>
                <h5>Total Registration: <strong>&#8369; <?php echo $totalregformat?></strong></h5>
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table">
                      <?php
                      $sql = "SELECT * FROM registration where valid=1 && batch_no='$year' ORDER BY datetime DESC";

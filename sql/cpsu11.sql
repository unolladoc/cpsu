...
-- Dumping data for table cpsu.campuses: ~10 rows (approximately)
...
-- Dumping data for table cpsu.files: ~6 rows (approximately)
DELETE FROM `files`;
...
-- Dumping data for table cpsu.logs: ~98 rows (approximately)
DELETE FROM `logs`;
...
-- Dumping data for table cpsu.m_typeofdoc: ~9 rows (approximately)
...
-- Dumping data for table cpsu.offices: ~0 rows (approximately)
DELETE FROM `offices`;
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `office` int(5) DEFAULT NULL,
  `type` int(1) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=latin1;

-- Dumping data for table cpsu.user: ~0 rows (approximately)
DELETE FROM `user`;
/*!40000 ALTER TABLE `user` DISABLE KEYS */;
INSERT INTO `user` (`id`, `username`, `password`, `name`, `campus`, `office`, `type`) VALUES
	(0000000001, 'admin@cpsu.com', '21232f297a57a5a743894a0e4a801fc3', 'Administrator', 1, 1000, 1),
	(0000000002, 'sai@yahoo.com', '81dc9bdb52d04dc20036dbd8313ed055', 'siari', 1, 1000, 2);

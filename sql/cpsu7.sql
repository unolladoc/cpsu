...
-- Dumping data for table cpsu.campuses: ~1 rows (approximately)
...
-- Dumping data for table cpsu.user: ~2 rows (approximately)
...
INSERT INTO `user` (`id`, `username`, `password`, `name`, `campus`, `office`, `type`) VALUES
	...
	(0000000002, 'xiari', '21232f297a57a5a743894a0e4a801fc3', 'xiari', 1, 1, 2);

...
-- Dumping data for table cpsu.files: ~4 rows (approximately)
DELETE FROM `files`;
/*!40000 ALTER TABLE `files` DISABLE KEYS */;
INSERT INTO `files` (`id`, `file_path`, `file_name`, `file_desc`, `file_extension`, `file_purpose`, `file_rev`, `uploader`, `origin`, `destination`, `finout`, `datetime`, `downloads`, `archive`, `archived_by`) VALUES
	('CPSU158101F3', 'files/1453807276978_INCOMING_1.jpg', '1453807276978_INCOMING_1.jpg', ' asdsada', 'JPG', 'Letter', '1', 0000000002, '1001', '["1000","1100"]', 1, '2019-05-28 14:09:36', 2, 0, ''),
	...
	('CPSU5870CDCA', 'files/1453807276978_REVISION_2.jpg', '1453807276978_REVISION_2.jpg', 'asdasdasd', 'JPG', 'Letter', '2', 0000000001, '1100', '["0"]', 0, '2019-05-28 13:23:11', 4, 0, 'CPSU43791451');
...
CREATE TABLE IF NOT EXISTS `logs` (
  ...
  `author` int(10) unsigned zerofill DEFAULT NULL,

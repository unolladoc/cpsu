...
-- Dumping data for table cpsu.offices: ~44 rows (approximately)
DELETE FROM `offices`;
...
INSERT INTO `offices` (`id`, `campus`, `office`) VALUES
	...
	(1011, 01, 'Dean College of Agriculture'),
	(1012, 01, 'Dean College of Animal Science'),
	(1013, 01, 'Dean College of Arts and Sciences'),
	(1014, 01, 'Dean College of Business Education'),
	(1015, 01, 'Dean College of Computer Studies'),
	(1016, 01, 'Dean College of Criminal Justice Education'),
	(1017, 01, 'Dean College of Engineering'),
	(1018, 01, 'Dean College of Forestry'),
	(1019, 01, 'Dean College of Teacher Education'),
	...
	(1123, 01, 'MIS Office'),
	(1124, 01, 'Library'),
	(2000, 02, 'Campus Director\'s Office'),
	(3000, 03, 'Campus Director\'s Office'),
	(4000, 04, 'Campus Director\'s Office'),
	(5000, 05, 'Campus Director\'s Office'),
	(6000, 06, 'Campus Director\'s Office'),
	(7000, 07, 'Campus Director\'s Office'),
	(8000, 08, 'Campus Director\'s Office'),
	(9000, 09, 'Campus Director\'s Office'),
	(10000, 10, 'Campus Director\'s Office');
